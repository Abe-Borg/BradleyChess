...
'''
Script for Converting Chess JSON Data to Pandas DataFrame and Pickle File

This script converts chess game data stored in JSON format into a pandas DataFrame and then saves it as a pickle file. The purpose of this script is to transform and preprocess chess data for further analysis or machine learning tasks.
...
Functions:
    convert_json_to_df(input_file_path, output_file_path):
        Converts a JSON file containing chess game data into a pandas DataFrame and saves it as a pickle file.
        Args:
            input_file_path (str): Path to the input JSON file.
            output_file_path (str): Path to the output pickle file.

Main Execution:
    - The script is designed to be run as a standalone program.
    - It processes multiple JSON files (commented out) and converts them to DataFrames.
...
def convert_json_to_df(input_file_path, output_file_path):
    ...
    Parameters:
        input_file_path (str): The path to the input JSON file containing chess game data.
        output_file_path (str): The path to the output pickle file where the DataFrame will be saved.

    Steps:
    1. Load and read the JSON file.
    2. Initialize an empty list to store the data for the DataFrame.
    3. Process each game in the dataset:
        - Initialize a dictionary for each game with 'Num Moves' and 'Result'.
        - Split the moves into 'Wn' and 'Bn' columns.
        - Append the game dictionary to the list.
    4. Create the DataFrame from the list of game dictionaries.
    5. Set the index to be the game number.
    6. Fill NaN values with an empty string for visual consistency.
    7. Fix the column order to place 'Result' at the end.
    8. Filter out games with invalid move counts.
    9. Export the DataFrame to a pickle file.
...
if __name__ == '__main__':
    ...
    # Uncomment the following lines to process multiple JSON files
    # convert_json_to_df(game_settings.chess_json_file_path_part_1, game_settings.chess_pd_dataframe_file_path_part_1)
    # convert_json_to_df(game_settings.chess_json_file_path_part_2, game_settings.chess_pd_dataframe_file_path_part_2)
    # convert_json_to_df(game_settings.chess_json_file_path_part_3, game_settings.chess_pd_dataframe_file_path_part_3)
    # convert_json_to_df(game_settings.chess_json_file_path_part_4, game_settings.chess_pd_dataframe_file_path_part_4)
    ...
    # Uncomment the following lines to process more JSON files
    # convert_json_to_df(game_settings.chess_json_file_path_part_13, game_settings.chess_pd_dataframe_file_path_part_13)
    # convert_json_to_df(game_settings.chess_json_file_path_part_14, game_settings.chess_pd_dataframe_file_path_part_14)
    # convert_json_to_df(game_settings.chess_json_file_path_part_15, game_settings.chess_pd_dataframe_file_path_part_15)
    # convert_json_to_df(game_settings.chess_json_file_path_part_16, game_settings.chess_pd_dataframe_file_path_part_16)
